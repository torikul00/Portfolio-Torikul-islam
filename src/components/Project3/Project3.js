                ...
                <section className='project-wrapper'>
                    ...
                    <div className="links">
                        ...
                        <div className="live-links">
                            <a target='blank' href="https://github.com/torikul00/Fruits-Buddy-Client"><button>Client Code</button></a>
                            <a target='blank' href="https://github.com/torikul00/Fruits-Buddy_Server"><button>Server Code</button></a>
                            <a target='blank' href="https://fruits-buddy.web.app/"><button>Live Link</button></a>
                        </div>
                    </div>
                </section>
            </div>
