                ...
                <section className='project-wrapper'>
                    ...
                    <div className="links">
                        ...
                        <div className="live-links">
                            <a target='blank' href="https://github.com/torikul00/Electrical-Galaxy"><button>Client Code</button></a>

                            <a target='blank' href="https://electrical-galaxy.web.app/"><button>Live Link</button></a>
                        </div>
                    </div>
                </section>
            </div>
